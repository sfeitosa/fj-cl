...
classC = Class "C" "Object" [] -- Base and derived class
           ...
           [(Method (Sign (Type "Supplier") "m" []) (Closure [] (CreateObject "Object" [])))] -- Methods
...
classtable = fromList [("Supplier", TInterface intSupplier), ("Function", TInterface intFunction), ("BiFunction", TInterface intBiFunction), ("A", TClass classA), ("B", TClass classB), ("C", TClass classC)]
